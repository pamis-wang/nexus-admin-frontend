...
import type { MenuSettingsDragMove, MenuSettingsTableRow } from '@/pages/MenuSettings/types'
...
interface MenuSettingsMoveEvent {
  /** 被拖曳的列 */
 ...
 */
function rowByElement(element: HTMLElement | null): MenuSettingsTableRow | null {
 ...
 */
function handleMove(event: MenuSettingsMoveEvent): boolean {
 ...
 */
function handleUpdate(event: DraggableEvent<MenuSettingsTableRow>) {
 ...
 * @param element 表格列
 */
function previewPath(element: MenuSettingsTableRow): string {
