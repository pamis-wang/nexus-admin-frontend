...
import type { AdminRolePermissionTreeNode, AdminRolePermissionType } from '@/pages/AdminRoleManagement/types'
...
const emit = defineEmits<{
  update: [resourceId: string, permissionType: AdminRolePermissionType, value: boolean]
}>()
...
interface Props {
  /** 巢狀的資源節點 */
  treeNodes: AdminRolePermissionTreeNode[]
  /** 查詢某個資源的權限 */
  hasPermission: (resourceId: string, permissionType: AdminRolePermissionType) => boolean
  /** 是否載入中 */
  isLoading?: boolean
  /** 是否唯讀（檢視頁用） */
  isReadonly?: boolean
