...
import type { AdminResourceMoveTarget } from '@/pages/AdminResourceManagement/types'
...
interface Props {
  ...
  /** 候選的目標父節點 */
  targets: AdminResourceMoveTarget[]
}
 ...
 */
function handleSelect(target: AdminResourceMoveTarget) {
  if (target.disabled) {
    return
  }
